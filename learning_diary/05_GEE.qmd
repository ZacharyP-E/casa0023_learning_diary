...
Sentinel-5P provided NO~2~ and SO~2~ products to quantify the variation occurring resultant of globally implemented lockdowns. The combination of remotely sensed data and statistical tests allowed the identification of both seasonal pollution values and a 30% average national reduction during the lockdown months. 

However, as was pointed out by @gil-alana2020, air pollution research should be subject to criticism, if 8 seasons of data before and after the change occurred were not considered. @ghasempour2021's conclusions should therefore be interpreted with caution as a strong bias may be present. 
